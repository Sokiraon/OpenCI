...
class Reporter {
    constructor() {
        ...
        _Reporter_messageStream.set(this, void 0);
    }
    init(pathSpecifier, messageStream) {
        let filePath = "";
        ...
        __classPrivateFieldSet(this, _Reporter_messageStream, messageStream, "f");
        if (createFile(filePath) === false) {
            messageStream === null || messageStream === void 0 ? void 0 : messageStream.write({
                type: "error",
    ...
    error(message) {
        __classPrivateFieldGet(this, _Reporter_instances, "m", _Reporter_log).call(this, message, figureSet.cross, chalk.red, "error");
...
_Reporter_filePath = new WeakMap(), _Reporter_jobId = new WeakMap(), _Reporter_messageStream = new WeakMap(), _Reporter_instances = new WeakSet(), _Reporter_log = function _Reporter_log(message, type, chalk, streamType = "output") {
    var _a, _b;
    if (message.endsWith("\n")) {
    ...
    for (let message of messageList) {
        ...
        if (type && chalk) {
            (_a = __classPrivateFieldGet(this, _Reporter_messageStream, "f")) === null || _a === void 0 ? void 0 : _a.write({
                type: streamType,
            ...
            (_b = __classPrivateFieldGet(this, _Reporter_messageStream, "f")) === null || _b === void 0 ? void 0 : _b.write({
                type: streamType,
